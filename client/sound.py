...
class SoundManager:
    def __init__(self):
        ...
        self.jetpack_sound.set_volume(0)  # Initially mute
        self.jetpack_fading_in = False

    def fade_in(self):
        if not self.jetpack_fading_in:
            self.jetpack_fading_in = True
            pygame.mixer.Sound.play(self.jetpack_sound, loops=-1)  # Play on loop
    ...
    def _increase_volume(self):
        ...
        if volume < 1.0:
            ...
            pygame.time.set_timer(pygame.USEREVENT, 50)  # Fade speed
